...
class WeddingForm(ContactForm):
    ...
    BRIDE_GROOM = (
        ('Bride/partner A', 'Bride/partner A only',),
        ('Both', 'Both bride/partner A and bridegroom/partner B',),
    )
    ...
    bride_name_first = forms.CharField(label=u'Bride\'s/partner A\'s first name', initial='Bride\'s/partner A\'s first name', max_length=100)
    bride_name_last = forms.CharField(label=u'Bride\'s/partner A\'s maiden name', initial='Bride\'s/partner A\'s maiden name', max_length=100)
    bride_work_phone = USPhoneNumberField(label=u'Bride\'s/partner A\'s work phone', help_text='(XXX-XXX-XXXX format)')
    bride_home_phone = USPhoneNumberField(label=u'Bride\'s/partner A\'s home phone', help_text='(XXX-XXX-XXXX format)')
    bride_city = forms.CharField(label=u'Bride\'s/partner A\'s city')
    bride_state = forms.ChoiceField(widget=HackedUSStateSelect(), choices=MY_STATE_CHOICES, label=u'Bride\'s/partner A\'s state', initial='OR')
    groom_name_first = forms.CharField(label=u'Bridegroom\'s/partner B\'s first name', initial='Groom\'s/partner B\'s first name', max_length=100)
    groom_name_last = forms.CharField(label=u'Bridegroom\'s/partner B\'s last name', initial='Groom\'s/partner B\'s last name', max_length=100)
    groom_work_phone = USPhoneNumberField(label=u'Bridegroom\'s/partner B\'s work phone', help_text='(XXX-XXX-XXXX format)')
    groom_home_phone = USPhoneNumberField(label=u'Bridegroom\'s/partner B\'s home phone', help_text='(XXX-XXX-XXXX format)')
    groom_city = forms.CharField(label=u'Bridegroom\'s/partner B\'s city')
    groom_state = forms.ChoiceField(widget=HackedUSStateSelect(), choices=MY_STATE_CHOICES, label=u'Bridegroom\'s/partner B\'s state', initial='OR')
    ...
    brides_parents_married = forms.ChoiceField(
        ...
        choices=YES_NO, 
        label=u'Bride\'s/partner A\'s parents',
        help_text='Divorced?',
    )
    brides_mother_living = forms.ChoiceField(
        widget=forms.RadioSelect(), 
        choices=YES_NO, 
        label=u'Bride\'s/partner A\'s mother',
        help_text='Deceased?',
    )
    brides_father_living = forms.ChoiceField(
        widget=forms.RadioSelect(), 
        choices=YES_NO, 
        label=u'Bride\'s/partner A\'s father',
        help_text='Deceased?',
    )
    brides_mother_name = forms.CharField(label=u'Bride\'s/partner A\'s mother\'s name (and name of spouse if remarried)', help_text=u'(Use first and last names.)')
    brides_mother_city = forms.CharField(label=u'Bride\'s/partner A\'s mother\'s city')
    brides_mother_state = forms.ChoiceField(widget=HackedUSStateSelect(), choices=MY_STATE_CHOICES, label=u'Bride\'s/partner A\'s mother\'s state')
    brides_mother_day_phone = forms.CharField(required=False, label=u'Bride\'s/partner A\'s mother\'s daytime phone', help_text='(XXX-XXX-XXXX format)')
    brides_father_name = forms.CharField(label=u'Bride\'s/partner A\'s father\'s name (and name of spouse if remarried)', help_text=u'(Use first and last names.)')
    brides_father_city = forms.CharField(label=u'Bride\'s/partner A\'s father\'s city')
    brides_father_state = forms.ChoiceField(widget=HackedUSStateSelect(), choices=MY_STATE_CHOICES, label=u'Bride\'s/partner A\'s father\'s state')
    brides_father_day_phone = forms.CharField(required=False, label=u'Bride\'s/partner A\'s father\'s daytime phone', help_text='(XXX-XXX-XXXX format)')
    
    grooms_parents_married = forms.ChoiceField(
        widget=forms.RadioSelect(), 
        choices=YES_NO, 
        label=u'Bridegroom\'s/partner B\'s parents',
        help_text='Divorced?',
    )
    grooms_mother_living = forms.ChoiceField(
        widget=forms.RadioSelect(), 
        choices=YES_NO, 
        label=u'Bridegroom\'s/partner B\'s mother',
        help_text='Deceased?',
    )
    grooms_father_living = forms.ChoiceField(
        widget=forms.RadioSelect(), 
        choices=YES_NO, 
        label=u'Bridegroom\'s/partner B\'s father',
        help_text='Deceased?',
    )
    grooms_mother_name = forms.CharField(label=u'Bridegroom\'s/partner B\'s mother\'s name (and name of spouse if remarried)', help_text=u'(Use first and last names.)')
    grooms_mother_city = forms.CharField(label=u'Bridegroom\'s/partner B\'s mother\'s city')
    grooms_mother_state = forms.ChoiceField(widget=HackedUSStateSelect(), choices=MY_STATE_CHOICES,  label=u'Bridegroom\'s/partner B\'s mother\'s state')
    grooms_mother_day_phone = forms.CharField(required=False, label=u'Bridegroom\'s/partner B\'s mother\'s daytime phone', help_text='(XXX-XXX-XXXX format)')
    grooms_father_name = forms.CharField(label=u'Bridegroom\'s/partner B\'s father\'s name (and name of spouse if remarried)', help_text=u'(Use first and last names.)')
    grooms_father_city = forms.CharField(label=u'Bridegroom\'s/partner B\'s father\'s city')
    grooms_father_state = forms.ChoiceField(widget=HackedUSStateSelect(), choices=MY_STATE_CHOICES, label=u'Bridegroom\'s/partner B\'s father\'s state')
    grooms_father_day_phone = forms.CharField(required=False, label=u'Bridegroom\'s/partner B\'s father\'s daytime phone', help_text='(XXX-XXX-XXXX format)')
    
    couples_future_home = forms.CharField(label=u'Couple\'s future home')
    brides_occupation = forms.CharField(label=u'Bride\'s/partner A\'s occupation')
    grooms_occupation = forms.CharField(label=u'Bridegroom\'s/partner B\'s occupation')
    
    bride_maiden_name = forms.ChoiceField(
        widget=forms.RadioSelect(), 
        choices=YES_NO, 
        label=u'Will the bride/partner A be keeping last name?',
    )
