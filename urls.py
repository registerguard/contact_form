...
#                            name='classifieds_feedback_contact_form'),
                       url(r'^wedding-announcement/$', 
                           contact_form, { 'form_class': WeddingForm, 
                               'template_name': 'contact_form/contact_form_wedding_announcement.html',
                               'success_url': '/pages/news-forms/', }, 
                           name='wedding_announcement'),
#                        url(r'^obituary/$',
